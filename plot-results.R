...
my_plot('results-mul.csv', 'multiplicity', 'Number of partitions')
...
my_plot('results-so.csv', 'num_physical_cpus', '# Physical CPUs for SO')
my_plot('results-so.csv', 'num_physical_cpus', '# Physical CPUs for SO', ylim=c(0, 0.25))
